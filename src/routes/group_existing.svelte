...
<svelte:head>
	<title>Trete einer Gruppe bei</title>
	<meta
		name="description"
...
<div class="grid-container-welcome">
	<div class="content_welcome">
		...
		<div class="welcome_title">
			<h3>Trete einer Gruppe bei</h3>
		</div>
		<div class="welcome_text">
			<p>Gib deine Gruppennummer ein.</p>
		</div>
		<div class="button_box">
			<!-- The text field -->
			<input class="link_box" type="text" bind:value={group} placeholder="57789" />
			{#if group > 0}
				<a rel="prefetch" class="button_size" href="/connected?group={group}"> Beitreten </a>
			{/if}
		</div>
	</div>
</div>

...
<svelte:head>
    <title>Willkommen im open-museum</title>
    <meta
        name="description"
...
<div class="grid-container-welcome">
    <div class="content_welcome">
        ...
        <div class="welcome_title">
            <h3 style="color: #ff00ff;">Willkommen!</h3>
        </div>
        <div class="welcome_text">
            <p>
                Stöbere im open-museum wie in einem echten Museum: Entdecke
                allein oder als Gruppe ausgewählte Inhalte zur Spanischen
                Grippe. Tausche dich über dein Mikrofon mit anderen
                Besucher*innen aus. In der Ausstellung kannst du das Mikrofon
                jederzeit stumm stellen. Falls du dich verlaufen hast, hilft dir
                der Übersichtsplan weiter.
            </p>
        </div>
        <div class="button_box">
            ...
            <a rel="prefetch" href="/group_select" class="button_size">
                Gruppe
            </a>
        </div>
    </div>

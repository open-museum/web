<script>
	...
	onMount(async () => {
		if ($page.query.error) {
			error = decodeURIComponent($page.query.error) + ' ';
		}
	});
</script>

<svelte:head>
	<title>Etwas ist schief gelaufen</title>
	<meta
		name="description"
...
<div class="grid-container-welcome">
	<div class="content_welcome">
		...
		<div class="welcome_title">
			<h3 style="color: #E67D7E;">Oh, nooo!</h3>
		</div>
		<div class="welcome_text">
			<p>Etwas ist schief gelaufen. {error}Was willst du tun?</p>
		</div>
		<div class="button_box">
			<a rel="prefetch" class="button_size" href="/" style="font-size: 0.7rem;">
				Ich probiere es nochmals
			</a>
			<a rel="prefetch" href="/spanish-flu/7" class="button_size" style="font-size: 0.7rem;">
				Ohne Chat
				<br />
				weiter
			</a>
